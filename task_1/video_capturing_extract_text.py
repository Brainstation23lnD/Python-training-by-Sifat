...
if __name__ == '__main__':
    ...
    parser.add_argument("--video_path", type=str, default="TextBasedExplainerVideo.mp4",
                        help="Path to the video file")
    parser.add_argument("--save_dir", type=str, default="stored_frames",
                        help="Directory to save frames")
    parser.add_argument("--interval", type=int, default=1,
                        help="Frame extraction interval")
    parser.add_argument("--interval_type", type=str, default="second",
                        help="Interval type: 'second' or 'frame'")
    parser.add_argument("--max_duration", type=int, default=10,
                        help="Maximum duration to process in seconds")
    parser.add_argument("--is_persist", type=bool, default=True,
                        help="Whether to save frames to disk")
